...
import { CostCenterFormData, ModalMode } from '../types/coce.types';
...
interface CostCenterModalProps {
  ...
  onUpdateCostCenter: () => void;
  onDeleteClick: () => void;
  onDelete: () => void;
  onEditMode: () => void;
}

export const CoCeModal: React.FC<CostCenterModalProps> = ({
  isOpen,
  mode,
  selectedCostCenter,
  formData,
    ...
    >
      ...
      >
        ...
        <div className="flex-grow overflow-y-auto pr-2">
          {mode === 'add' || mode === 'edit' ? (
          ...
          ) : mode === 'view' && selectedCostCenter && !showDeleteConfirm ? (
            <div className="space-y-2 text-sm">
              <p style={{ color: secondaryTextColor }}>
                <strong>Nombre:</strong> {selectedCostCenter?.name}
              </p>
            </div>
            ...
            <div style={{ color: textColor }} className="text-center">
              ...
              <p className="mb-4">
                Estás a punto de eliminar al centro de costo{' '}
