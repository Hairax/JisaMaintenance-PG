...
import { Objeto, ObjetoFormData, ModalMode } from '../types/objeto.types';
    ...
    >
      ...
      >
        ...
        <div className="flex-grow overflow-y-auto pr-2">
          {mode === 'add' || mode === 'edit' ? (
          ...
          ) : mode === 'view' && selectedObjeto && !showDeleteConfirm ? (
            <div className="space-y-2 text-sm">
              <p>
                <strong style={{ color: secondaryTextColor }}>ID:</strong>{' '}
                <span style={{ color: textColor }}>{selectedObjeto.id}</span>
              </p>
              <p>
                <strong style={{ color: secondaryTextColor }}>Nombre:</strong>{' '}
                <span style={{ color: textColor }}>
                  {selectedObjeto.nombre}
                </span>
              </p>
              <p>
                <strong style={{ color: secondaryTextColor }}>Creado:</strong>{' '}
                <span style={{ color: textColor }}>
                  {selectedObjeto.createdAt
                    ? new Date(selectedObjeto.createdAt).toLocaleString()
                    : '-'}
                </span>
              </p>
              <p>
                ...
                <span style={{ color: textColor }}>
                  {selectedObjeto.updatedAt
                    ? new Date(selectedObjeto.updatedAt).toLocaleString()
                    : '-'}
                </span>
              </p>
            </div>
          ) : showDeleteConfirm && selectedObjeto ? (
            <div style={{ color: textColor }} className="text-center">
              ...
              <p className="mb-4">
                ...
                <strong className="font-medium">{selectedObjeto.nombre}</strong>
                .
              </p>
              <p className="text-sm mb-4">
                Esta acción eliminará de manera permanente el objeto.
              </p>
              {deleteCountdown > 0 && (
                <p
